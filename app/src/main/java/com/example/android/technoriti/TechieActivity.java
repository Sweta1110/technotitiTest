...
public class TechieActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ViewAnimator viewAnimator5 = (ViewAnimator)this.findViewById(R.id.viewFlipper5);
        ...
        viewAnimator5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AnimationFactory.flipTransition(viewAnimator5, AnimationFactory.FlipDirection.LEFT_RIGHT);
            }
        ...
        this.findViewById(R.id.view_parakram5).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // This is all you need to do to 3D flip
                AnimationFactory.flipTransition(viewAnimator5, AnimationFactory.FlipDirection.LEFT_RIGHT);
        ...
        this.findViewById(R.id.btn_back5).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // This is all you need to do to 3D flip
                AnimationFactory.flipTransition(viewAnimator5, AnimationFactory.FlipDirection.LEFT_RIGHT);
